...
const DoctorCard = ({ doctor, onViewProfile }) => {
  ...
  return (
    <article className='group relative flex h-full flex-col overflow-hidden rounded-2xl border border-white/50 bg-white/90 shadow-lg shadow-[#07332F]/5 backdrop-blur transition duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-[#07332F]/10'>
      ...
      <div className='flex flex-1 flex-col px-5 pb-6 pt-5'>
        <div className='flex items-start justify-between gap-4'>
          <div>
            <h3 className='text-xl font-semibold text-[#07332F]'>{doctor.name}</h3>
          ...
          <div className='text-right'>
            ...
            <p className='mt-1 text-xs font-medium text-slate-500'>{ratingValue} / 5 rating</p>
          </div>
        </div>
        ...
        <div className='mt-4 flex flex-wrap gap-2'>
          {tags.length ? (
            ...
            <span className='text-xs font-semibold text-slate-500'>No specialties listed</span>
          )}
        </div>
