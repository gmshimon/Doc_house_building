...
import expertDoc1 from '../../assets/expert_doc_1.jpg'
import expertDoc2 from '../../assets/expert_doc_2.jpg'
...
const doctors = [
  {
    ...
    fee: 15,
    image: expertDoc1,
    tags: ['Sports rehab', 'Manual therapy', 'Pain management']
  },
  {
    id: 2,
    name: 'Dr. Samuel Hossain',
    title: 'MBBS, FCPS - Cardiology',
    rating: 4.9,
    experience: 15,
    location: 'Gulshan, Dhaka, Bangladesh',
    availability: 'Tue, 23 December',
    fee: 25,
    image: expertDoc2,
    tags: ['Heart health', 'Hypertension', 'Lifestyle coaching']
  },
  {
    id: 3,
    name: 'Dr. Nabila Rahman',
    title: 'MBBS - Internal Medicine',
    rating: 4.7,
    experience: 10,
    location: 'Banani, Dhaka, Bangladesh',
    availability: 'Wed, 24 December',
    fee: 20,
    image: doc3,
    tags: ['Preventive care', 'Diabetes', "Women's wellness"]
  }
]
              ...
              <div className='flex flex-1 flex-col px-5 pb-6 pt-5'>
                ...
                <div className='mt-4 space-y-3 text-sm text-slate-700'>
                  ...
                  <div className='flex items-center gap-3'>
                    ...
                    <span>Available on {doctor.availability}</span>
                  </div>
                  <div className='flex items-center gap-3'>
                    <span className='flex h-9 w-9 items-center justify-center rounded-full bg-[#F7A582]/15 text-lg text-[#F7A582]'>
